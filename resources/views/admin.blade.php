...
|---------------------------------------------------------|
-->
<body class="hold-transition sidebar-mini h-screen">
<div id="app" class="d-flex wrapper flex-column justify-content-between">
  <!-- Navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
            <span data-letters="{{ Auth::user()->name[0] }}" data-toggle="tooltip" ></span>
        </div>
        <div class="info">
